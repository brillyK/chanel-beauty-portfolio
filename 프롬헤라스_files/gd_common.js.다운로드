...
$(document).ready(function () {
    ...
    var detailv2 = new Swiper(".swiper-container--detailv2", {
        slidesPerView: "auto",
        spaceBetween: 0,
        navigation: {
    ...
    $(".review_star_wrap .star_wrap span").click(function(){
        let idx = $(this).index()
        $(".review_star_wrap .star_wrap span").each(function(){
            if($(this).index() <= idx){
    ...
    jQuery.extend(jQuery.validator.messages, {
        ...
        maxlength: jQuery.validator.format(__("최대 %i자 이하 입력해 주세요.", "{0}")),
        minlength: jQuery.validator.format(__("최소 %i자 이상 입력해 주세요.", "{0}")),
        ...
        max: jQuery.validator.format(__("최대 %i자 이상 입력하실 수 없습니다.", "{0}")),
        min: jQuery.validator.format(__("최소 %i자 이하 입력하실 수 없습니다.", "{0}"))
    });
